...
export default function Sidebar({ activeMenu, setActiveMenu, onLogout }: SidebarProps) {
  ...
  const menuConfig = useMemo(() => [
    ...
    { type: "item", id: 'peta-sampah', label: 'Tracking Rute', icon: Map, color: 'from-emerald-500 to-teal-500', href: '/admin/PetaSampah' },
    {
  ...
  },
    {
      ...
      icon: Newspaper,
      items: [
      { id: 'berita', label: 'Berita', icon: Newspaper, color: 'from-green-500 to-emerald-600', href: '/admin/berita' },
