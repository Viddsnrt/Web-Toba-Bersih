...
export default function AdminPage() {
  ...
  const [data, setData] = useState({ laporan: [], posts: [] });
  ...
  const fetchAllData = useCallback(async () => {
    ...
    // Fetch laporan dan posts secara terpisah agar salah satu gagal tidak block yang lain
    const [laporanResult, postsResult] = await Promise.allSettled([
      api.get('/laporan'),
      api.get('/posts'),
    ]);
    ...
    setData({ laporan: laporanData, posts: postsData });
    console.log('[Admin] Data fetched:', { laporan: laporanData.length, posts: postsData.length });
